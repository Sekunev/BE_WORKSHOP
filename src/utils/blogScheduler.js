...
class BlogScheduler {
  ...
  async start() {
    ...
    // Her gün saat 11:59'te blog oluştur
    const dailyTask = cron.schedule('59 11 * * *', async () => {
    ...
    console.log('📅 Günlük blog: Her gün 11:59');
  ...
  getStatus() {
    return {
      ...
      schedules: [
        { name: 'Günlük Blog', cron: '59 11 * * *', description: 'Her gün saat 11:59' },
