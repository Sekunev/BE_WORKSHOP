...
class BlogScheduler {
  ...
  async start() {
    ...
    // Her gün saat 12:01'te blog oluştur
    const dailyTask = cron.schedule('01 12 * * *', async () => {
    ...
    console.log('📅 Günlük blog: Her gün 12:01');
  ...
  getStatus() {
    return {
      ...
      schedules: [
        { name: 'Günlük Blog', cron: '01 12 * * *', description: 'Her gün saat 12:01' },
