...
class BlogScheduler {
  ...
  async start() {
    ...
    // Her gün saat 14:51'te blog oluştur
    const dailyTask = cron.schedule('51 14 * * *', async () => {
    ...
    console.log('📅 Günlük blog: Her gün 14:51');
  ...
  getStatus() {
    return {
      ...
      schedules: [
        { name: 'Günlük Blog', cron: '51 14 * * *', description: 'Her gün saat 14:51' },
